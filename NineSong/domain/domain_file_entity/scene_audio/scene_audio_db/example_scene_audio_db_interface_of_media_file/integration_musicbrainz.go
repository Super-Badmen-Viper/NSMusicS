...
type MusicBrainzIntegration interface {
	...
	// 高级查询
	FindByMBZAlbum(ctx context.Context, mbzAlbumID string) ([]*scene_audio_db_models.MediaFileMetadata, error)
	FindByMBZArtist(ctx context.Context, mbzArtistID string) ([]*scene_audio_db_models.MediaFileMetadata, error)
}
