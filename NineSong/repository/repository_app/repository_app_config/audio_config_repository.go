...
type AppAudioConfigRepository interface {
	ReplaceAll(ctx context.Context, configs []*domain_app_config.AppAudioConfig) error
	GetAll(ctx context.Context) ([]*domain_app_config.AppAudioConfig, error)
}
...
func (r *AppAudioConfigRepo) ReplaceAll(ctx context.Context, configs []*domain_app_config.AppAudioConfig) error {
...
func convertToInterfaceSliceAppAudioConfig(configs []*domain_app_config.AppAudioConfig) []interface{} {
...
func (r *AppAudioConfigRepo) GetAll(ctx context.Context) ([]*domain_app_config.AppAudioConfig, error) {
	coll := r.db.Collection(r.collection)
	...
	var configs []*domain_app_config.AppAudioConfig
