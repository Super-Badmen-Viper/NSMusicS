...
type AppLibraryConfigRepository interface {
	ReplaceAll(ctx context.Context, configs []*domain_app_config.AppLibraryConfig) error
	GetAll(ctx context.Context) ([]*domain_app_config.AppLibraryConfig, error)
}
...
func (r *libraryConfigRepo) ReplaceAll(ctx context.Context, configs []*domain_app_config.AppLibraryConfig) error {
...
func convertToInterfaceSliceAppLibraryConfig(configs []*domain_app_config.AppLibraryConfig) []interface{} {
...
func (r *libraryConfigRepo) GetAll(ctx context.Context) ([]*domain_app_config.AppLibraryConfig, error) {
	coll := r.db.Collection(r.collection)
	...
	var configs []*domain_app_config.AppLibraryConfig
