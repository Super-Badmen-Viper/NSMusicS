...
func NewPlaylistRepository(db mongo.Database, collection string) scene_audio_db_interface.PlaylistRepository {
...
func (r *playlistRepository) Upsert(ctx context.Context, file *scene_audio_db_models.PlaylistMetadata) error {
...
func (r *playlistRepository) BulkUpsert(ctx context.Context, files []*scene_audio_db_models.PlaylistMetadata) (int, error) {
	coll := r.db.Collection(r.collection)
...
func (r *playlistRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*scene_audio_db_models.PlaylistMetadata, error) {
	coll := r.db.Collection(r.collection)
	result := coll.FindOne(ctx, bson.M{"_id": id})

	var file scene_audio_db_models.PlaylistMetadata
...
func (r *playlistRepository) GetByPath(ctx context.Context, path string) (*scene_audio_db_models.PlaylistMetadata, error) {
	coll := r.db.Collection(r.collection)
