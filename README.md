...
## Note: This project is about to complete the personal official version 1.0 update. After the iteration of the version is completed, it will be copied to the open source community: MoZhiYun (Mo Zhiyun)
...
- - 1. [MoZhiYunOpenSourceCommunity]（ https://github.com/MoZhiYunOpenSourceCommunity ）(Mo Zhiyun Open Source Community): MoZhiMusic Community Edition

- - 2. [MoZhiYunStudio]（ https://github.com/SnakeBigBossDemo ）(Mo Zhiyun Studio): MoZhiMusic Ultimate (paid music copyright, partly open source, copyright owned by Cheng Xiang (lead author))
