...
using MoZhiMusicPlayer_GithubAuthor_XiangCheng.Models.Song_Audio_Out.CSCore_Ffmpeg.Interops;

namespace MoZhiMusicPlayer_GithubAuthor_XiangCheng.Models.Song_Audio_Out.CSCore_Ffmpeg
{
    /// <summary>
    /// FFmpeg Exception
    /// </summary>
    public class FfmpegException : Exception
    {
        ...
        /// <exception cref="MoZhiMusicPlayer_GithubAuthor_XiangCheng.Models.Song_Audio_Out.CSCore_Ffmpeg.FfmpegException"><see cref="FfmpegException"/> with some details (including the <paramref name="errorCode"/> and the <paramref name="function"/>).</exception>
