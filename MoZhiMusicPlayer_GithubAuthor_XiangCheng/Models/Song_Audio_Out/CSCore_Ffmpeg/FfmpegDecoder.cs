...
namespace MoZhiMusicPlayer_GithubAuthor_XiangCheng.Models.Song_Audio_Out.CSCore_Ffmpeg
{
    ...
    ///     use the binaries shipped with the MoZhiMusicPlayer_GithubAuthor_XiangCheng.Models.Song_Audio_Out.CSCore_Ffmpeg project.
