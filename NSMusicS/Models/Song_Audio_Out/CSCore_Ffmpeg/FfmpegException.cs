...
using NSMusicS.Models.Song_Audio_Out.CSCore_Ffmpeg.Interops;
...
namespace NSMusicS.Models.Song_Audio_Out.CSCore_Ffmpeg
{
    ...
    public class FfmpegException : Exception
    {
        ...
        /// <exception cref="NSMusicS.Models.Song_Audio_Out.CSCore_Ffmpeg.FfmpegException"><see cref="FfmpegException"/> with some details (including the <paramref name="errorCode"/> and the <paramref name="function"/>).</exception>
