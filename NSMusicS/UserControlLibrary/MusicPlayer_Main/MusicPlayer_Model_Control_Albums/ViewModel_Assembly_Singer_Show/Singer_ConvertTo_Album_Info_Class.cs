...
{
    public class Singer_ConvertTo_Album_Info_Class
    {
        ...
        public static Singer_ConvertTo_Album_Info_Class Singer_Info_Class_s { get; set; }
        public static Singer_ConvertTo_Album_Info_Class Retuen_This()
        {
            Singer_Info_Class_s = Return_This_();
            return Singer_Info_Class_s;
        }
        private static Singer_ConvertTo_Album_Info_Class Return_This_()
        {
            if (Singer_Info_Class_s == null)
                Singer_Info_Class_s = new Singer_ConvertTo_Album_Info_Class();
