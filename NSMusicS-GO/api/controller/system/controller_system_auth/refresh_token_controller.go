package controller_system_auth
...
type RefreshTokenController struct {
	RefreshTokenUsecase domain_system_auth.RefreshTokenUsecase
	Env                 *bootstrap.Env
}

func (rtc *RefreshTokenController) RefreshToken(c *gin.Context) {
	var request domain_system_auth.RefreshTokenRequest
	...
	refreshTokenResponse := domain_system_auth.RefreshTokenResponse{
