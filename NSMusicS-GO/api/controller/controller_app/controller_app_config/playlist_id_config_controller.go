...
type AppPlaylistIDConfigController struct {
	usecase domain_app_config.AppPlaylistIDConfigUsecase
}

func NewAppPlaylistIDConfigController(uc domain_app_config.AppPlaylistIDConfigUsecase) *AppPlaylistIDConfigController {
	return &AppPlaylistIDConfigController{usecase: uc}
}

func (ctrl *AppPlaylistIDConfigController) ReplaceAll(c *gin.Context) {
	var req []*domain_app_config.AppPlaylistIDConfig
