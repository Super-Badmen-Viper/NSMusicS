...
type SignupController struct {
	SignupUsecase basic.SignupUsecase
	Env           *bootstrap.Env
}

func (sc *SignupController) Signup(c *gin.Context) {
	var request basic.SignupRequest
	...
	if err == nil {
		c.JSON(http.StatusConflict, basic_response.ErrorResponse{Message: "User already exists with the given email"})
		return
	}
	...
	signupResponse := basic.SignupResponse{
