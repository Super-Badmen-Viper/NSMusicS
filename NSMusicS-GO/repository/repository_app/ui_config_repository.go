...
func (r *AppUIConfigRepo) ReplaceAll(ctx context.Context, configs []*domain_app.AppUIConfig) error {
...
func convertToInterfaceSliceAppUIConfig(configs []*domain_app.AppUIConfig) []interface{} {
...
func (r *AppUIConfigRepo) GetAll(ctx context.Context) ([]*domain_app.AppUIConfig, error) {
	...
	var configs []*domain_app.AppUIConfig
