...
func (r *annotationRepository) Upsert(ctx context.Context, file *scene_audio_db_models.AnnotationMetadata) error {
...
func (r *annotationRepository) BulkUpsert(ctx context.Context, files []*scene_audio_db_models.AnnotationMetadata) (int, error) {
	coll := r.db.Collection(r.collection)
...
func (r *annotationRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*scene_audio_db_models.AnnotationMetadata, error) {
	coll := r.db.Collection(r.collection)
	result := coll.FindOne(ctx, bson.M{"_id": id})

	var file scene_audio_db_models.AnnotationMetadata
...
func (r *annotationRepository) GetByPath(ctx context.Context, path string) (*scene_audio_db_models.AnnotationMetadata, error) {
	coll := r.db.Collection(r.collection)
