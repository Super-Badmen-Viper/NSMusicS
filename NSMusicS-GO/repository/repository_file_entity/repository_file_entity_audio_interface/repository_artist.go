...
func NewArtistRepository(db mongo.Database, collection string) domain_file_entity_audio_interface.ArtistRepository {
...
func (r *artistRepository) Upsert(ctx context.Context, artist *domain_file_entity_audio_models.ArtistMetadata) error {
...
func (r *artistRepository) BulkUpsert(ctx context.Context, artists []*domain_file_entity_audio_models.ArtistMetadata) (int, error) {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*domain_file_entity_audio_models.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
	result := coll.FindOne(ctx, bson.M{"_id": id})

	var artist domain_file_entity_audio_models.ArtistMetadata
...
func (r *artistRepository) GetByName(ctx context.Context, name string) (*domain_file_entity_audio_models.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
...
func (r *artistRepository) GetByMBID(ctx context.Context, mbzID string) (*domain_file_entity_audio_models.ArtistMetadata, error) {
	coll := r.db.Collection(r.collection)
