package repository_system_auth_test
...
func TestCreate(t *testing.T) {
	...
	collectionName := domain_system_auth.CollectionUser

	mockUser := &domain_system_auth.User{
	...
	mockEmptyUser := &domain_system_auth.User{}
	...
	t.Run("success", func(t *testing.T) {
		...
		ur := repository_system_auth.NewUserRepository(databaseHelper, collectionName)
