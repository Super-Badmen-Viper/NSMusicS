...
const (
	CollectionServerInfo = "system_info"
)
...
type ServerInfoUsecase interface {
	Get(ctx context.Context) (*ServerInfoResponse, error)
	Update(ctx context.Context, info *ServerInfo) error
}
