...
} from "../../Navidrome_Api_Services_Web";

export class Media_Lists_ApiWebService_of_ND extends Navidrome_Api_Services_Web {
    public async getMediaList_ALL(
    ...
    public async getMediaList_of_Playlist(
        playlist_id: string,
        _end:string, _order:string, _sort:string, _start: string,
        year:string
    ): Promise<any> {
