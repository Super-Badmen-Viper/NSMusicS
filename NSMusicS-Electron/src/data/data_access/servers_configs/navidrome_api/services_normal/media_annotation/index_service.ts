...
export class Media_Annotation_ApiService_of_ND extends Navidrome_Api_Services_Normal {
  public async set_star(
    username: string,
    token: string,
    salt: string,
    id: string,
