    ...
    protected async sendRequest(
        ...
        try {
            if(store_server_user_model.authorization_of_Je != undefined &&
                ...
                const headers = {
                    'Authorization': `MediaBrowser Token="${store_server_user_model.authorization_of_Je}", Client="Electron Desktop", Device="NSMusicS", DeviceId="NSMusicS-GO", Version="1.3.1"`
                };
