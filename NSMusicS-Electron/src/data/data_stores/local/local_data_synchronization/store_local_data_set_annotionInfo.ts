...
import {Set_AnnotationInfo_To_LocalSqlite} from "../../../data_access/local_configs/class_Set_AnnotationInfo_To_LocalSqlite";
import {
    store_server_data_set_annotionInfo
} from "@/data/data_stores/server/server_data_synchronization/store_server_data_set_annotionInfo";
...
export const store_local_data_set_annotionInfo = reactive({
    ...
    Set_MediaInfo_To_Selected_PlayCount_of_Delete(ids: string[], value: Boolean) {
        set_AnnotationInfo_To_LocalSqlite.Set_MediaInfo_To_Selected_PlayCount_of_Delete_Local(ids, value)
    }
});