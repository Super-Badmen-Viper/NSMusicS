        ...
        try {
            ...
            try {
                ...
                if (!isElectron) {
                    let exists = false;
                    let itemIndex = -1;
                    store_server_users.server_config_of_all_user_of_sqlite.forEach((item: any, index: number) => {
                    ...
                    if (!exists) {
                        ...
                        if (itemIndex !== -1) {
                            store_server_users.server_config_of_all_user_of_sqlite[itemIndex].password = store_server_login_info.server_accessToken;
                        }
                    }
                }
                /// server label
            ...
            try {
                ...
                // init_server_token
                // replace apikey
                store_server_auth_token.app_load_init_server_token()
            } catch (e) {
                console.error(e)
            }
