export class Audio_Players {
  ...
  public setFadein(): void {
    ...
    this.fadeGainNode.gain.setValueCurveAtTime(
      waveArray,
  ...
  public setFadeout(): void {
    ...
    this.fadeGainNode.gain.setValueCurveAtTime(
      waveArray,
      this.audioContext.currentTime + this.audioDuration - this.fadeout + 0.001,
      this.fadeout
    )
  }
  ...
  private createChunk(chunk: Float32Array) {
    const audioBuffer = this.audioContext.createBuffer(2, chunk.length, this.sampleRate)
