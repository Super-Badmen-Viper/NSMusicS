          ...
          AIFFDemuxer = (function (_super) {
            ...
            AIFFDemuxer.probe = function (buffer) {
              ...
              return (
                ...
                ((_ref = buffer.peekString(8, 4)) === 'AIFF' || _ref === 'AIFC')
              )
            }
                ...
                switch (this.type) {
                  case 'COMM':
                    ...
                    this.format.bytesPerPacket =
                      (this.format.bitsPerChannel / 8) * this.format.channelsPerFrame
                    ...
                    this.emit(
                      'duration',
                      ((this.format.sampleCount / this.format.sampleRate) * 1000) | 0
                    )
                    break
                  case 'SSND':
            ...
            AUDemuxer.prototype.readChunk = function () {
              ...
              if (!this.readHeader && this.stream.available(24)) {
                ...
                if (dataSize !== 0xffffffff) {
                  ...
                  this.emit(
                    'duration',
                    ((dataSize / bytes / this.format.channelsPerFrame / this.format.sampleRate) *
                      1000) |
                      0
                  )
                }
              ...
              while (this.stream.available(1)) {
                ...
                switch (this.headerCache.type) {
                  ...
                  case 'pakt':
                    if (this.stream.available(this.headerCache.size)) {
                      ...
                      for (i = _i = 0, _ref = this.numPackets; _i < _ref; i = _i += 1) {
                        ...
                        byteOffset +=
                          this.format.bytesPerPacket || M4ADemuxer.readDescrLen(this.stream)
                        sampleOffset +=
                          this.format.framesPerPacket || M4ADemuxer.readDescrLen(this.stream)
                      }
                      this.headerCache = null
                    }
                    break
                  case 'info':
                    ...
                    for (
                      i = _j = 0;
                      0 <= entries ? _j < entries : _j > entries;
                      i = 0 <= entries ? ++_j : --_j
                    ) {
          ...
          M4ADemuxer = (function (_super) {
            ...
            M4ADemuxer.prototype.setupSeekPoints = function () {
              ...
              for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
                position = _ref[i]
                for (
                  j = _j = 0, _ref1 = this.track.stsc[stscIndex].count;
                  _j < _ref1;
                  j = _j += 1
                ) {
            ...
            M4ADemuxer.prototype.parseChapters = function () {
              ...
              while (this.chapters.length < track.seekPoints.length) {
                ...
                nextTimestamp =
                  (_ref2 =
                    (_ref3 = track.seekPoints[this.chapters.length + 1]) != null
                      ? _ref3.timestamp
                      : void 0) != null
                    ? _ref2
                    : track.duration
          ...
          MozillaAudioDevice = (function (_super) {
            ...
            createTimer = function (fn, interval) {
              ...
              url = AVBuffer.makeBlobURL(
                "setInterval(function() { postMessage('ping'); }, " + interval + ');'
              )
              if (url == null) {
          ...
          ;(function (global) {
            ...
            WebAudioDevice = (function (_super) {
              ...
              WebAudioDevice.supported =
                AudioContext &&
                (typeof AudioContext.prototype[(createProcessor = 'createScriptProcessor')] ===
                  'function' ||
                  typeof AudioContext.prototype[(createProcessor = 'createJavaScriptNode')] ===
                    'function')
              ...
              function WebAudioDevice(sampleRate, channels) {
                ...
                this.refill = __bind(this.refill, this)
                this.context =
                  sharedContext != null ? sharedContext : (sharedContext = new AudioContext())
                this.deviceSampleRate = this.context.sampleRate
                this.bufferSize = Math.ceil(
                  (4096 / (this.deviceSampleRate / this.sampleRate)) * this.channels
                )
        ...
        function (_dereq_, module, exports) {
          ...
          HTTPSource = (function (_super) {
            ...
            HTTPSource.prototype.start = function () {
              ...
              this.xhr.onload = (function (_this) {
                return function (event) {
                  ...
                  if (_this.xhr.getResponseHeader('Content-Length') === null) {
                    _this.length = -1
                  }
              ...
              this.xhr.open('HEAD', 'https://cors-anywhere.herokuapp.com/' + this.url, true)
            ...
            HTTPSource.prototype.loop = function () {
              ...
              this.xhr.open('GET', 'https://cors-anywhere.herokuapp.com/' + this.url, true)
