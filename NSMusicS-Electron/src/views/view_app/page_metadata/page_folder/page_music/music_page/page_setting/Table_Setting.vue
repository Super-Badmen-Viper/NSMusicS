<script setup lang="ts">
  ...
  const computed_i18n_Label_SidebarConfiguration_12 = computed(() => t('nsmusics.siderbar_menu.identifyMedia'));
    ...
    <n-layout
      ...
      <n-card
        ...
        <n-tabs
            ...
            v-model:value="store_app_configs_info.app_view_local_client_setting_select_tab_name"
            size="large" animated
