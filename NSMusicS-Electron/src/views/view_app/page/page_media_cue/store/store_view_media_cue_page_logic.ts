...
import { store_local_data_set_annotionInfo } from '@/data/data_stores/local_stores/local_data_synchronization/store_local_data_set_annotionInfo'
...
export const store_view_media_cue_page_logic = reactive({
  ...
  set_media_Files_selected(value: Media_File) {
    if (value.selected) {
      ...
      store_view_media_cue_page_info.media_Files_selected =
        store_view_media_cue_page_info.media_Files_selected.filter(
  ...
  set_media_Files_selected_all(value: boolean) {
    ...
    if (value) {
      store_view_media_cue_page_info.media_Files_selected =
        store_view_media_cue_page_info.media_Files_temporary.slice()
    } else {
      store_view_media_cue_page_info.media_Files_selected = []
    }
...
watch(
  () => store_view_media_cue_page_logic.list_data_StartUpdate,
  async (newValue) => {
    if (newValue) {
      store_view_media_cue_page_logic.page_songlists_keyword = ''
      if (store_view_media_cue_page_logic.list_selected_Hand_click) {
