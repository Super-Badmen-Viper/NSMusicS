...
// --- Computed Properties ---
const wordCloudTags = computed(() => store_view_recommend_page_info.recommend_WordCloudTag_metadata.value)
const wordCloudGenres = computed(
  () => store_view_recommend_page_info.recommend_WordCloudGenre_metadata.value
)
const finalSongList = computed(() => pageRecommendStore.recommend_MediaFiles_temporary.value)
  ...
  <n-message-provider>
    <div style="position: absolute; top: 0">
      ...
      <div style="font-size: 12px; margin-left: 11px">
        阶段 1: 词云(标签)推荐 -> 阶段 2: 播放相似度推荐 -> 阶段 3: 知识图谱推荐 -> 阶段 4:
        DeepSeek大模型推荐
      </div>
    </div>
