...
<template>
  <n-space
    ...
    align="center"
    :style="{
      marginTop: player_background_model_num === 5 ? '0px' : '100px',
      opacity: player_background_model_num === 5 ? 1 : 0,
      position: player_background_model_num === 5 ? 'relative' : 'absolute',
      left: player_background_model_num === 5 ? '0' : '-100%',
