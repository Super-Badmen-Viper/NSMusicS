...
//////
import Group_0_1 from "@/views/view_setting/components/group_0_client_settings/group_0_1_ClientSettings_Libraries.vue"
import Group_0_2 from "@/views/view_setting/components/group_0_client_settings/group_0_2_ClientSettings_GeneralTab.vue"
import Group_0_3 from "@/views/view_setting/components/group_0_client_settings/group_0_3_ClientSettings_PlaybackTab.vue"
import Group_0_4 from "@/views/view_setting/components/group_0_client_settings/group_0_4_ClientSettings_HotkeysTab.vue"
import Group_0_5 from "@/views/view_setting/components/group_0_client_settings/group_0_5_ClientSettings_WindowTab.vue"
        ...
        <n-layout has-sider
          ...
          <n-layout embedded style="overflow-y: auto;border-radius: 4px;">
            <div style="margin-left: 14px;margin-top: 10px;margin-right: 14px;">
              <!--客户端-->
              <Group_0_1
                  v-if="store_app_configs_info.app_view_page_server_setting_select_tab_name === 'type-group-0-1'"
              />
              <Group_0_2
                  v-if="store_app_configs_info.app_view_page_server_setting_select_tab_name === 'type-group-0-2'"
              />
              <Group_0_3
                  v-if="store_app_configs_info.app_view_page_server_setting_select_tab_name === 'type-group-0-3'"
              />
              <Group_0_4
                  v-if="store_app_configs_info.app_view_page_server_setting_select_tab_name === 'type-group-0-4'"
              />
              <Group_0_5
                  v-if="store_app_configs_info.app_view_page_server_setting_select_tab_name === 'type-group-0-5'"
              />
              <!--服务器-->
              <Group11TabDashboard
