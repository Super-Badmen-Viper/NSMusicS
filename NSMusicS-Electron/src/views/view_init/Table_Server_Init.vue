    ...
    <n-config-provider :theme="darkTheme">
      ...
      <n-space
        ...
        <n-card
          style="
          top: 30vh;
          border: 2px solid #FFFFFF20;border-radius: 10px;
          background-color: #18181C75;
          width: 300px;">
          <n-space justify="center" style="margin-top: -60px;margin-bottom: 10px;">
            <img :src="NSMusicS" style="width: 70px;height: 70px;border: 2px solid #18181C80;border-radius: 12px;" alt=""/>
          ...
          <n-form>
            ...
            <n-space vertical style="margin-bottom: 10px;">
              ...
              <n-input clearable type="password" show-password-on="click" placeholder="any"
