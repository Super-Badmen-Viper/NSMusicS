    ...
    save_system_config_of_App_Configs(){
        ...
        const app_Configs = ref(
            new App_Configs({
                ...
                player_view_left_menu_select_activeKey: String(store_app_configs_info.player_view_left_menu_select_activeKey),
                player_view_left_menu_collapsed: String(store_app_configs_info.player_view_left_menu_collapsed),
