...
{
    public class Extracting_Audio_Spectrum
    {
        public Extracting_Audio_Spectrum()
        {
            InitializeCapture();
        ...
        public void StartStopBtn_Click()
        {
            ...
            audio_Info.IsRecording ^= true;
        }


        private static Extracting_Audio_Spectrum audioSpectrogram;
        public static Extracting_Audio_Spectrum Retuen_This()
        {
            audioSpectrogram = Return_This_listView_Item_Bing_ALL();
            return audioSpectrogram;
        }
        public static Extracting_Audio_Spectrum Return_This_listView_Item_Bing_ALL()
        {
            if (audioSpectrogram == null)
            {
                audioSpectrogram = new Extracting_Audio_Spectrum();
            }
            return audioSpectrogram;
        }

        public List<float> animation_points = new List<float>();
        public Audio_Info audio_Info = new Audio_Info();
        ...
        {
            if (audio_Info.IsPlaying && reader != null)
            {
        ...
        {
            if (audio_Info.IsRecording && audio_Info.IsSaveFile)
