...
namespace NSMusicS.Dao_UserControl.Song_Mrc_Info
{
    class Dao_ListBox_Temp_MRC
    {
        ...
        public ObservableCollection<Dao_ListBox_Temp_MRC_Bing> Return_ListBox_Temp_MRC_Bing(string CRC_URL)
        {
            ObservableCollection<Dao_ListBox_Temp_MRC_Bing> Temp_MRC_Bing = new ObservableCollection<Dao_ListBox_Temp_MRC_Bing>();
