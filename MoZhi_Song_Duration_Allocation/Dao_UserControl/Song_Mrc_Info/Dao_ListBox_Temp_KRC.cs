        ...
        public Dao_ListBox_Temp_MRC_Bing[] Return_ListBox_Temp_MRC_Bing(string CRC_URL)
        {
            ...
            for (int i = 0; i < LRC_Text.Length; i++)
            {
                if (LRC_Text[i] != null)
                {
                    ...
                    //将剩余的空格，替换为 _
                    //LRC_Text[i] = LRC_Text[i].Replace(" ", "_");
                }
            }
                ...
                for (int i = Temp_MRC_Bing.Length - 1; i >= 0; i--)
                {
                    ...
                    if (Temp_MRC_Bing[i] != null)
                    {
                        ...
                        singer_Mrc_To_Substring =
                            singer_Mrc_To_Substring.Substring(0, singer_Mrc_To_Substring.LastIndexOf(")") + 1) +
                            "\n" +
                            singer_Mrc_To_Substring.Substring(singer_Mrc_To_Substring.LastIndexOf(")") + 1)
                            ;
