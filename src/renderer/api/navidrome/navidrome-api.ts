...
import axios, { type Method, AxiosError, type AxiosResponse, isAxiosError } from 'axios';
...
const parsePath = (fullPath: string) => {
    ...
    const notNilParams = omitBy(newParams, (value: string) => value === 'undefined' || value === 'null');
