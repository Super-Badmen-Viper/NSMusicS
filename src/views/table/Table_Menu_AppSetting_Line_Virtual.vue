    ...
    <n-layout
      ...
      <n-card
        ...
        <n-tabs
                          ...
                          <n-card style="width: 450px;border-radius: 6px;">
                            <n-space
                              ...
                              <n-space justify="space-between" style="margin-bottom: 12px;">
                                <span style="font-size: 20px;font-weight: 600;">服务器设置</span>
                              ...
                              <n-form style="margin-top: -12px;">
                                <n-form-item label="服务器名" size="small">
                                  <n-input clearable size="small" :default-value="item.name"/>
                                </n-form-item>
                                <n-form-item label="URL" size="small">
                                  <n-input-group>
                                    <n-input-group-label size="small">http://</n-input-group-label>
                                    <n-input clearable size="small" :default-value="item.url"/>
                                  </n-input-group>
                                </n-form-item>
                                <n-form-item label="用户名" size="small">
                                  <n-input clearable size="small" :default-value="item.username"/>
                                </n-form-item>
                                <n-form-item label="密码" size="small">
                                  <n-input clearable type="password" show-password-on="click" size="small" :default-value="item.password"/>
                                </n-form-item>
                              </n-form>
                              <n-space justify="end">
              ...
              <n-modal
                ...
                <n-card style="width: 450px;border-radius: 6px;">
                  <n-space
                    vertical size="large" style="width: 400px;">
                    <n-space justify="space-between">
                      <span style="font-size: 20px;font-weight: 600;">添加服务器</span>
                    ...
                    <n-form inline>
                      <n-form-item label="服务器名" style="width: 150px;">
                        <n-input clearable />
                      </n-form-item>
                      <n-form-item label="URL" style="width: 250px;">
                        <n-input-group>
                    ...
                    <n-form style="margin-top: -12px;">
                      ...
                      <n-form-item label="密码">
                        <n-input clearable type="password" show-password-on="click"/>
                      </n-form-item>
                    </n-form>
                    <n-space justify="end">
          ...
          <!-- 通用 -->
          <n-tab-pane name="tab_pane_2" tab="通用">
            <n-scrollbar style="max-height: 70vh;" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 203) + 'px)'}">
              <n-space vertical>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">语言</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">设置此应用的语言(重启生效)</span>
                    </div>
                  </n-space>
                  <n-select
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">跟随系统</span>
                    <div style="margin-top: -10px;">
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">保存播放列表</span>
                    <div style="margin-top: -10px;">
                ...
                <n-space vertical :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space justify="space-between" align="center">
                    <n-space vertical>
                      <span style="font-size:16px;">主页配置</span>
                      <div style="margin-top: -10px;">
                        <span style="font-size:12px;">当应用程序关闭时保存播放队列，并在应用程序打开时恢复它</span>
                      </div>
                    </n-space>
                ...
                <n-space vertical :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space justify="space-between" align="center">
                    <n-space vertical>
                      <span style="font-size:16px;">侧边栏设定</span>
                      <div style="margin-top: -10px;">
                  ...
                  <n-checkbox-group>
                    <n-grid :y-gap="8" :cols="4">
                      ...
                      <n-gi><n-checkbox value="Pushes Open" label="乐曲" /></n-gi>
                      <n-gi><n-checkbox value="The Window" label="艺术家" /></n-gi>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">清除NSMusicS缓存</span>
                    <div style="margin-top: -10px;">
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">清除浏览器缓存</span>
                    <div style="margin-top: -10px;">
          ...
          <!-- 播放 -->
          <n-tab-pane name="tab_pane_3" tab="播放">
            <n-scrollbar style="max-height: 70vh;" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 203) + 'px)'}">
              <n-space vertical>
                <!-- 通用-语言-字体 -->
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">音频设备</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">设置此应用的语言(重启生效)</span>
                    </div>
                  </n-space>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">选择播放器的播放风格</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">设置此应用的语言(重启生效)</span>
                    </div>
                  </n-space>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">淡入淡出持续时间</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">设置此应用的语言(重启生效)</span>
                    </div>
                  </n-space>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">采样率</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">设置此应用的语言(重启生效)</span>
                    </div>
                  </n-space>
                ...
                <n-space justify="space-between" align="center" :style="{ width: 'calc(100vw - ' + (collapsed_width - 9 + 230) + 'px)'}">
                  <n-space vertical>
                    <span style="font-size:16px;">歌词偏移</span>
                    <div style="margin-top: -10px;">
                      <span style="font-size:12px;">使用系统定义的浅色或深色主题</span>
                    </div>
                  </n-space>
          ...
          <!-- 快捷键 -->
          <n-tab-pane name="tab_pane_4" tab="快捷键">
            
          </n-tab-pane>
          <!-- 窗口 -->
          <n-tab-pane name="tab_pane_5" tab="窗口">
